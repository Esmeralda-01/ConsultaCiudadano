...
public class RegistrarCiudadano extends AppCompatActivity {
    Button btnAceptar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtInputRH = findViewById(R.id.textInputLayoutRH);
        txtRHR = findViewById(R.id.txtRHR);
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<>(
                RegistrarCiudadano.this,
                R.layout.dropdown_item,
                rhs
        );
        txtRHR.setAdapter(adapter);

        textInputLayoutGrupSan = findViewById(R.id.textInputLayoutGrupSan);
        txtGrupoSanR = findViewById(R.id.txtGrupoSanR);
        ...
        txtNoIdR = findViewById(R.id.txtNoIdR);
        txtFechaER = findViewById(R.id.txtFechaER);
        txtLugarER = findViewById(R.id.txtLugarER);
        txtFechaNR = findViewById(R.id.txtFechaNR);
        txtLugarNR = findViewById(R.id.txtLugarNR);
        txtEstaturaR = findViewById(R.id.txtEstaturaR);

        btnAceptar = findViewById(R.id.btnAceptar);
        btnAceptar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                registrarCiudadano(txtNombresR.getText().toString(),txtApellidosR.getText().toString(),txtNoIdR.getText().toString(),txtFechaER.getText().toString(),txtLugarER.getText().toString(),txtFechaNR.getText().toString(),txtLugarNR.getText().toString(),txtRHR.getText().toString(),txtGrupoSanR.getText().toString(),txtEstaturaR.getText().toString());
              }
        });
    }
    private void registrarCiudadano(String nombres, String apellidos, String id,String fecha_exp, String lugar_exp, String fecha_nac, String lugar_nac,
        ...
        //String url = "https://antecedentes--back.herokuapp.com/api/registro-ciudadano?p_nombre=jj&s_nombre=pp&p_apellido=oo&s_apellido=dd&id=555556784&fecha_exp=2001-08-06&lugar_exp=2001-08-06&fecha_nac=2001-08-06&lugar_nac=1&rh=+&g_sanguineo=a&estatura=156&tipo_doc=1&sexo=1";
         String url = "https://antecedentes--back.herokuapp.com/api/registro-ciudadano?p_nombre="+p_n+"&s_nombre="+s_n+"&p_apellido="+p_a+
         "&s_apellido="+s_a+
         "&id="+id+
         "&fecha_exp="+fecha_exp+
         "&lugar_exp="+lugar_exp+
         ...
         "&tipo_doc=1"+
         "&sexo=1";
        RequestQueue queue = Volley.newRequestQueue(RegistrarCiudadano.this);
        StringRequest request = new StringRequest(Request.Method.POST, url, new com.android.volley.Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(RegistrarCiudadano.this, "Fail to get response = " + error, Toast.LENGTH_LONG).show();
            }
        });
        queue.add(request);
    }
    ...
    private void mostrarDialogoRegis(){
        AlertDialog.Builder builder = new AlertDialog.Builder(RegistrarCiudadano.this);
        LayoutInflater inflater = getLayoutInflater();

        View view = inflater.inflate(R.layout.activity_dialog_exito_c,null);
        builder.setView(view);
        AlertDialog dialog = builder.create();
        dialog.show();

        Button btnAceptar = view.findViewById(R.id.btnListo2);
        btnAceptar.setOnClickListener(new View.OnClickListener() {
            @Override
